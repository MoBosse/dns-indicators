...
var mapView = function () {
  ...
  //---#2.1 caseNoTimeSeriesInCsv---stop-------------------------------------
    ...
    $('#map').sdgMap({
      ...
      mapLayers: [{"min_zoom":4.5,"max_zoom":7.5,"serviceUrl":"https://mobosse.github.io/dns-indicators/assets/maps/diy_lan.geojson","nameProperty":"GEN","idProperty":"AGS","staticBorders":true},{"min_zoom":8,"max_zoom":11,"serviceUrl":"https://mobosse.github.io/dns-indicators/assets/maps/diy_krs.geojson","nameProperty":"GEN","idProperty":"ARS","staticBorders":true}],
      //---#1 GoalDependendMapColor---start--------------------------------------
      goal: goal,
      //---#1 GoalDependendMapColor---stop---------------------------------------
